# Erdős Problem 512 — drafting inputs
...
<title>512 | Erdős Problems</title>
<meta property="og:title" content="512 | Erdős Problems">
...
<div class="container">
  ...
  [Ko81] Konyagin, S. V., <i>On the Littlewood problem</i>. Izv. Akad. Nauk SSSR Ser. Mat. (1981), 243-265, 463.
  
  [MPS81] McGehee, O. Carruth and Pigno, Louis and Smith, Brent, <i>Hardy's inequality and the {$L\sp{1}$} norm of exponential<br>sums</i>. Ann. of Math. (2) (1981), 613-618.
  
  </div>
                                        
  <div class="problem-additional-text" style="text-align:center; padding: 10px;">
  <a href="/512">Back to the problem</a>
  </div>
...
## Hosted theorem — jayyhk (https://github.com/Jayyhk/erdos-lean/blob/main/problems/512/Erdos512.lean)
...
theorem TrigPolyNeg.coAnalytic {φ : AddCircle (1 : ℝ) → ℂ} (h : TrigPolyNeg φ) :
  ...
  intro n hn;
  obtain ⟨ s, c, hs, he ⟩ := h;
  rw [ show φ = _ from funext he, fourierCoe
```
