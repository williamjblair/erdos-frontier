# Erdős Problem 403 — drafting inputs
...
<title>403 | Erdős Problems</title>
<meta property="og:title" content="403 | Erdős Problems">
...
<div class="container">
  ...
  [Li76] Lin, S., <i>On two problems of Erd\H{o}s concerning sums of distinct factorials</i>. Bell Laboratories internal memorandum (1960).
  
  </div>
                                        
  <div class="problem-additional-text" style="text-align:center; padding: 10px;">
  <a href="/403">Back to the problem</a>
  </div>
...
## Hosted theorem — jayyhk (https://github.com/Jayyhk/erdos-lean/blob/main/problems/403/Erdos403.lean)
...
theorem erdos403 (m : ℕ) :
    (∃ s : Finset ℕ, IsErdos403Solution m s) ↔ m ∈ ({0, 1, 3, 5, 7} : Finset ℕ)
```
