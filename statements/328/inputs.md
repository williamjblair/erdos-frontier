# Erdős Problem 328 — drafting inputs
...
<title>328 | Erdős Problems</title>
<meta property="og:title" content="328 | Erdős Problems">
...
<div class="container">
  ...
  Asked by Erd\H{o}s and Newman. Ne\v{s}et\v{r}il and R\"{o}dl \cite{NeRo85} have shown the answer is no for all $C$ (even if $t$ is also allowed to depend on $A$).<br><br>Erd\H{o}s \cite{Er80e} had previously shown the answer is no for $C=3,4$ and infinitely many other values of $C$.<br><br>See also <a href="/774" rel="nofollow noopener noreferrer ugc" target="_blank">[774]</a>.
  ...
  [Er80e] Erd\H{o}s, P., <i>Some applications of Ramsey's theorem to additive number<br>theory</i>. European J. Combin. (1980), 43-46.
  
  [NeRo85] J. Ne\v{s}et\v{r}il and V. R\"{o}dl, <i>Two proofs in combinatorial number theory</i>. Proc. Amer. Math. Soc. (1985), 185-188.
  
  </div>
                                        
  <div class="problem-additional-text" style="text-align:center; padding: 10px;">
  <a href="/328">Back to the problem</a>
  </div>
...
## Hosted theorem — jayyhk (https://github.com/Jayyhk/erdos-lean/blob/main/problems/328/Erdos328.lean)
