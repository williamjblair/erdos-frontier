# Erdős Problem 209 — drafting inputs
...
<title>209 | Erdős Problems</title>
<meta property="og:title" content="209 | Erdős Problems">
...
<div class="container">
  ...
  [Es16] Escudero, Juan Garc\'{i}a, <i>Gallai triangles in configurations of lines in the projective plane</i>. C. R. Math. Acad. Sci. Paris (2016), 551-554.
  
  [FuPa84] F\"{u}redi, Z. and Pal\'{a}sti, I., <i>Arrangements of lines with a large number of triangles</i>. Proc. Amer. Math. Soc. (1984), 561-566.
  
  </div>
                                        
  <div class="problem-additional-text" style="text-align:center; padding: 10px;">
  <a href="/209">Back to the problem</a>
  </div>
...
## Hosted theorem — jayyhk (https://github.com/Jayyhk/erdos-lean/blob/main/problems/209/Erdos209.lean)
