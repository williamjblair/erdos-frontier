# Match-check packet — Erdős problem 258
...
- Verdict: `conditional`
- Non-kernel axioms: `tao_teravainen` (visible to `#print axioms`)
...
- Boxed problem: https://www.erdosproblems.com/258
- LaTeX source: https://www.erdosproblems.com/latex/258
- Upstream state: `proved (Lean)`

## 2. FC theorem

- File: `FormalConjectures/ErdosProblems/258.lean`
- View: https://github.com/google-deepmind/formal-conjectures/blob/main/FormalConjectures/ErdosProblems/258.lean
- Linked formal_proof: yes

## 3. Hosted theorem signature(s)

- plby/lean-proofs — state `conditional` (conditional)
  - https://github.com/plby/lean-proofs/blob/main/src/v4.29.1/ErdosProblems/Erdos258.lean
- Jayyhk/erdos-lean — state `axiomatic` (conditional)
  - https://github.com/Jayyhk/erdos-lean/blob/main/problems/258/Erdos258.lean
