# Match-check packet — Erdős problem 1121
...
- LaTeX source: https://www.erdosproblems.com/latex/1121
...
- plby/lean-proofs — state `complete` (complete)
  - https://github.com/plby/lean-proofs/blob/main/src/v4.29.1/ErdosProblems/Erdos1121.lean
